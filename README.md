...
Ce dépôt contient un parcours pédagogique en français consacré à EthereumJS : EVM, transactions, blocs, état, tries et hardforks. Consultez le [sommaire du parcours](docs/fr/README.md).
